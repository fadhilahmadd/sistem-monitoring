<div>
    ...
    <x-jet-form-section submit="createApiToken">
        ...
        <x-slot name="description">
            {{ __('Token API memungkinkan layanan pihak ketiga untuk mengautentikasi diri dengan aplikasi kami atas nama Anda.') }}
        </x-slot>
    ...
    @if ($this->user->tokens->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    {{ __('Anda dapat menghapus token yang sudah ada jika tidak lagi diperlukan.') }}
                </x-slot>
    ...
    <x-jet-dialog-modal wire:model="displayingToken">
        ...
        <x-slot name="content">
            <div>
                {{ __('Silakan salin token API baru Anda. Untuk keamanan Anda, token ini tidak akan ditampilkan lagi.') }}
            </div>
    ...
    <x-jet-confirmation-modal wire:model="confirmingApiTokenDeletion">
        ...
        <x-slot name="content">
            {{ __('Apakah Anda yakin ingin menghapus token API ini?') }}
        </x-slot>
